# Graph Report - ..\WhatsappApis  (2026-05-05)

## Corpus Check
- 11923 files · ~10,588,842 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 65249 nodes · 79219 edges · 11079 communities (4832 shown, 6247 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 4202 edges (avg confidence: 0.8)
...
5. `Assert` - 234 edges
6. `json_encode()` - 190 edges
7. `Standard` - 189 edges
8. `Configuration` - 171 edges
9. `Configuration` - 168 edges
10. `Model` - 163 edges

## Surprising Connections (you probably didn't know these)
- `up()` --calls--> `throw_if()`  [INFERRED]
  database/migrations/2026_05_05_064134_create_permission_tables.php → vendor/laravel/framework/src/Illuminate/Support/helpers.php
- `down()` --calls--> `throw_if()`  [INFERRED]
  database/migrations/2026_05_05_064134_create_permission_tables.php → vendor/laravel/framework/src/Illuminate/Support/helpers.php
...
- `prop()` --calls--> `Arr`  [INFERRED]
  vendor/inertiajs/inertia-laravel/src/Testing/Concerns/PageObject.php → vendor/laravel/framework/src/Illuminate/Collections/Arr.php

## Communities (11079 total, 6247 thin omitted)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (150): ac(), ad(), af(), al(), Am(), Av(), bd(), bh() (+142 more)

### Community 2 - "Community 2"
Cohesion: 0.01
Nodes (55): Text, Text, Text, Ean, VarCloner, DateComparator, NumberComparator, compileBreak() (+47 more)

### Community 4 - "Community 4"
Cohesion: 0.01
Nodes (26): Arr, getGlobalScope(), getGlobalScopes(), addLoop(), getLastLoop(), ForkDriver, PredisConnector, SqsConnector (+18 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (79): sodium_add(), sodium_base642bin(), sodium_bin2base64(), sodium_bin2hex(), sodium_compare(), sodium_crypto_aead_aes256gcm_decrypt(), sodium_crypto_aead_aes256gcm_encrypt(), sodium_crypto_aead_aes256gcm_is_available() (+71 more)
...
Cohesion: 0.03
Nodes (89): addXs(), categories(), category(), config(), convertPixelToScale(), d1(), dataLabelFormat(), Dr() (+81 more)

### Community 10 - "Community 10"
Cohesion: 0.02
Nodes (23): LogBroadcaster, RedisBroadcaster, toVercelProtocolResponse(), composeInstructions(), InvokeSerializedClosureCommand, HasInDatabase, NotSoftDeletedInDatabase, SoftDeletedInDatabase (+15 more)
...
Cohesion: 0.02
Nodes (35): BedrockImageGateway, runCase(), runSuite(), Json, LogFileReader, parseServerSentEvents(), readLine(), JsonMatches (+27 more)

### Community 17 - "Community 17"
Cohesion: 0.02
Nodes (15): ParagonIE_Sodium_Core_ChaCha20, ParagonIE_Sodium_Core_HChaCha20, ParagonIE_Sodium_Core_Util, sodium_crypto_aead_chacha20poly1305_ietf_decrypt(), sodium_crypto_aead_chacha20poly1305_ietf_encrypt(), sodium_crypto_aead_xchacha20poly1305_ietf_decrypt(), sodium_crypto_box_publickey(), sodium_crypto_box_seal() (+7 more)

### Community 22 - "Community 22"
Cohesion: 0.04
Nodes (102): arcData(), ax(), barLineBubbleData(), Be(), circleX(), clickHandlerForMultipleXS(), clickHandlerForSingleX(), convertValuesToRange() (+94 more)

### Community 23 - "Community 23"
Cohesion: 0.03
Nodes (94): addBrushHandle(), addHiddenLegendIds(), addHiddenTargetIds(), addTargetIds(), Ai(), appendClip(), Au(), bindTooltipResizePos() (+86 more)
...
Cohesion: 0.04
Nodes (8): CramMd5Authenticator, Uuid, EndpointProviderV2, Uuid, SqsClient, Avatar, Pusher, PusherCrypto

### Community 31 - "Community 31"
Cohesion: 0.04
Nodes (83): $(), A(), ah(), B(), Bm(), Bs(), cc(), cl() (+75 more)

### Community 32 - "Community 32"
Cohesion: 0.04
Nodes (10): Bind, broadcastVia(), Repository, enum_value(), getDictionaryKey(), Storage, PermissionMiddleware, ArrayRule (+2 more)
...
Cohesion: 0.03
Nodes (11): DeduplicationHandler, RawMessage, DiffOnlyOutputBuilder, StreamOutput, StrictUnifiedDiffOutputBuilder, UnifiedDiffOutputBuilder, AbstractPipes, DirectoryProgressTracker (+3 more)
...
Cohesion: 0.04
Nodes (28): findAvailableModels(), ProcessDriver, InstallCommand, installApiStack(), removeScaffoldingUnnecessaryForApis(), installBladeStack(), configureReactHydrateRootForSsr(), configureZiggyForSsr() (+20 more)
...
Cohesion: 0.04
Nodes (6): Class_, ClassConst, Enum_, Method, Param, BuilderHelpers
...
Cohesion: 0.04
Nodes (66): ag(), bg(), bt(), ch(), Ci(), color(), copy(), Cr() (+58 more)

### Community 60 - "Community 60"
Cohesion: 0.05
Nodes (4): NumberFormatException, RoundingNecessaryException, CalculatorRegistry, BigInteger

### Community 64 - "Community 64"
Cohesion: 0.06
Nodes (4): FilesystemAdapter, down(), up(), throw_if()

### Community 65 - "Community 65"
Cohesion: 0.06
Nodes (66): bindFunnelEvent(), bindRadarEvent(), Ei(), f0(), generatePoint(), getChartClass(), getClass(), getDefsPointId() (+58 more)
...
Cohesion: 0.06
Nodes (56): dispatchSync(), UpCommand, abort(), abort_if(), action(), app(), asset(), auth() (+48 more)
...
Cohesion: 0.04
Nodes (6): BucketEndpointMiddleware, ExpiresParsingMiddleware, PermanentRedirectMiddleware, PutObjectUrlMiddleware, S3Client, InputValidationMiddleware
...
Cohesion: 0.04
Nodes (12): EmailAutolinkParser, UrlAutolinkParser, AutolinkParser, BangParser, EscapableParser, HtmlInlineParser, InlineParserMatch, NewlineParser (+4 more)
...
Cohesion: 0.07
Nodes (4): AuthSelectionMiddleware, AwsClient, EndpointParameterMiddleware, StreamRequestPayloadMiddleware
...
Cohesion: 0.08
Nodes (3): AstRuntime, FnDispatcher, TreeInterpreter

### Community 128 - "Community 128"
Cohesion: 0.05
Nodes (6): RunkitReloader, MagicMethodsMatcher, MagicPropertiesMatcher, MagicMethodSource, MagicPropertySource, Docblock
...
Cohesion: 0.05
Nodes (6): ArnParser, DownloadDirectoryRequest, UploadDirectoryRequest, BucketEndpointArnMiddleware, MultipartCopy, StsClient

### Community 135 - "Community 135"
Cohesion: 0.05
Nodes (5): ParagonIE_Sodium_Core_AEGIS_State128L, ParagonIE_Sodium_Core_AEGIS_State256, ParagonIE_Sodium_Core_Base64_Common, ParagonIE_Sodium_Core_AEGIS128L, ParagonIE_Sodium_Core_AEGIS256

### Community 136 - "Community 136"
Cohesion: 0.08
Nodes (47): addName(), bindArcEvent(), convertToArcData(), filterTargetsToShow(), generateGetFunnelPoints(), getArcLabelFormat(), getArcLength(), getHiddenTotalDataSum() (+39 more)
...
Cohesion: 0.05
Nodes (8): ApiProvider, DocDBClient, Ec2Client, GlacierClient, NeptuneClient, RdsClient, SesClient, PresignUrlMiddleware

### Community 141 - "Community 141"
Cohesion: 0.06
Nodes (44): bindTouchOnEventRect(), cleanUpFlow(), cn(), co(), destroy(), dm(), filterByXDomain(), generateDrawArea() (+36 more)
...
Cohesion: 0.06
Nodes (7): b(), Ki, l(), n(), r(), W, Y

### Community 145 - "Community 145"
Cohesion: 0.05
Nodes (8): assertFileAddedToStore(), assertFileNotAddedToStore(), assertFileNotRemovedFromStore(), assertFileRemovedFromStore(), fileIdMatches(), fileMatchingCallback(), FakeStoreGateway, Stores

### Community 152 - "Community 152"
Cohesion: 0.07
Nodes (36): add(), callOverOutForTouch(), dc(), f1, fc, generateColor(), generateGetRadarPoints(), generateRadarPoints() (+28 more)
...
Cohesion: 0.09
Nodes (4): Signable, Signing, SigningResult, SignatureV4
...
Cohesion: 0.06
Nodes (3): Base64Document, Files, Store
...
Cohesion: 0.06
Nodes (7): ProfileCollector, Starter, Timer, Benchmark, HRTime, SystemStopWatch, SystemStopWatchWithOffset
...
Cohesion: 0.07
Nodes (6): DumpController, EntryController, ExceptionController, QueueBatchesController, QueueController, EntryQueryOptions

### Community 194 - "Community 194"
Cohesion: 0.06
Nodes (38): checkValueInTargets(), convertDataToTargets(), Es(), Fu(), generateDrawLine(), generateLegendItem(), getCurrentPadding(), getGaugeLabelHeight() (+30 more)

### Community 197 - "Community 197"
Cohesion: 0.06
Nodes (5): EndpointProvider, PartitionEndpointProvider, EndpointDefinitionProvider, EventBridgeClient, EventBridgeEndpointMiddleware
...
Cohesion: 0.1
Nodes (24): BatchDelete, checkExistenceWithCommand(), copy(), copyAsync(), deleteMatchingObjects(), deleteMatchingObjectsAsync(), determineBucketRegion(), determineBucketRegionAsync() (+16 more)

### Community 210 - "Community 210"
Cohesion: 0.1
Nodes (3): SetCookie, trigger_deprecation(), Image

### Community 217 - "Community 217"
Cohesion: 0.1
Nodes (3): EntryModelFactory, DatabaseEntriesRepository, EntryModel
...
Cohesion: 0.06
Nodes (5): AbstractModel, ListShape, MapShape, Shape, ShapeMap

### Community 234 - "Community 234"
Cohesion: 0.07
Nodes (4): Arn, MultiRegionAccessPointArn, OutpostsAccessPointArn, OutpostsBucketArn
...
Cohesion: 0.06
Nodes (5): ParagonIE_Sodium_Core_Ed25519, sodium_crypto_sign_ed25519_pk_to_curve25519(), sodium_crypto_sign_publickey(), sodium_crypto_sign_publickey_from_secretkey(), sodium_crypto_sign_secretkey()
...
Cohesion: 0.08
Nodes (7): StorageLinkCommand, StorageUnlinkCommand, public_path(), Mix, ViteFonts, bootPackageAssets(), BundleDetector

### Community 268 - "Community 268"
Cohesion: 0.15
Nodes (29): bootHasPermissions(), checkPermissionTo(), collectPermissions(), convertToPermissionModels(), ensureModelSharesGuard(), filterPermission(), forgetCachedPermissions(), forgetWildcardPermissionIndex() (+21 more)

### Community 271 - "Community 271"
Cohesion: 0.26
Nodes (22): buildToolResultsInput(), combineUsage(), continueWithToolResults(), ensureToolInputIsObject(), excludeThinkingParts(), executeToolCalls(), extractCitations(), extractFinishReason() (+14 more)

### Community 273 - "Community 273"
Cohesion: 0.07
Nodes (9): buildDockerCompose(), composePath(), prepareInstallation(), runCommands(), SymfonyYamlFrontMatterParser, YamlFileDumper, InvalidFrontMatterException, ArrayConverter (+1 more)
...
Cohesion: 0.09
Nodes (3): CborEncoder, Helper, String_

### Community 287 - "Community 287"
Cohesion: 0.09
Nodes (12): BroadcastAgent, InvokeAgent, broadcast(), broadcastNow(), broadcastOnQueue(), getDefaultModelFor(), getProvidersAndModels(), getTimeout() (+4 more)
...
Cohesion: 0.1
Nodes (4): ServiceProvider, AgentDetector, AgentResult, detectAgent()

### Community 316 - "Community 316"
Cohesion: 0.09
Nodes (4): Iban, CborDecoder, Xml, Text

### Community 317 - "Community 317"
Cohesion: 0.11
Nodes (9): copyServiceProviderInApp(), processCopyServiceProviderInApp(), config_path(), bootPackageConfigs(), normalizeConfigKey(), normalizeConfigPath(), registerPackageConfigs(), SanctumServiceProvider (+1 more)
...
Cohesion: 0.08
Nodes (5): Starter, WrapperRunner, Plugin, Execution, CaptureFilter
...
Cohesion: 0.1
Nodes (8): encrypt(), encryptCommitingStream(), encryptNonCommitingStream(), getCommitingEncryptionStream(), getNonCommittingEncryptingStream(), HeadersMetadataStrategy, InstructionFileMetadataStrategy, MetadataEnvelope
...
Cohesion: 0.08
Nodes (3): TeamModelNotConfigured, TeamsNotEnabled, Config
...
Cohesion: 0.1
Nodes (4): CacheWarmer, File, JobRunner, PhpProcess

### Community 392 - "Community 392"
Cohesion: 0.11
Nodes (16): getCipherBlockSizeBits(), getCipherBlockSizeBytes(), getCipherMaxContentLengthBits(), getCipherMaxContentLengthBytes(), getCipherTagLengthBits(), getCipherTagLengthInBytes(), getCommitmentInputKeyLengthBits(), getCommitmentInputKeyLengthBytes() (+8 more)
...
Cohesion: 0.09
Nodes (4): StreamEnd, TextDelta, StreamableAgentResponse, StreamedAgentResponse

### Community 415 - "Community 415"
Cohesion: 0.13
Nodes (7): UpgradeForTeamsCommand, DumpCommand, database_path(), bootPackageMigrations(), discoverPackageMigrations(), generateMigrationName(), AiServiceProvider

### Community 420 - "Community 420"
Cohesion: 0.14
Nodes (24): call(), createTestRequest(), createTestResponse(), delete(), deleteJson(), extractFilesFromDataArray(), followRedirects(), formatServerHeaderKey() (+16 more)

### Community 423 - "Community 423"
Cohesion: 0.11
Nodes (4): registerMailableTagExtractor(), ExtractTags, FormatModel, NotificationWatcher
...
Cohesion: 0.14
Nodes (3): EntryUpdate, ExtractProperties, JobWatcher

### Community 496 - "Community 496"
Cohesion: 0.13
Nodes (20): circleY(), dist(), getRedrawList(), getShapeYMin(), getYScaleById(), gr(), isGrouped(), jp() (+12 more)
...
Cohesion: 0.18
Nodes (11): applyTextOptions(), assembleRequestBody(), buildChatRequestBody(), buildResponseFormat(), buildResponseSchema(), buildSchemaFormat(), buildStructuredOutputTool(), buildTextRequestBody() (+3 more)
...
Cohesion: 0.2
Nodes (18): assignRole(), bootHasRoles(), collectRoles(), convertPipeToArray(), getRoleClass(), getRoleNames(), getStoredRole(), hasAllRoles() (+10 more)
...
Cohesion: 0.1
Nodes (4): GuardDoesNotMatch, RoleAlreadyExists, RoleDoesNotExist, Role

### Community 547 - "Community 547"
Cohesion: 0.11
Nodes (4): validateCommitmentPolicyOnEncrypt(), getKeyCommitmentPolicy(), MaterialsProviderV3, S3EncryptionClientV3
...
Cohesion: 0.12
Nodes (8): dir_iterator(), flatmap(), is_valid_epoch(), is_valid_hostlabel(), is_valid_hostname(), map(), parse_ini_section_with_subsections(), recursive_dir_iterator()

### Community 592 - "Community 592"
Cohesion: 0.13
Nodes (3): RuleCreator, TreeRule, Ruleset
...
Cohesion: 0.4
Nodes (9): mapAssistantMessage(), mapMessages(), mapMessagesToChat(), mapMessagesToContents(), mapMessagesToInput(), mapToolResultMessage(), mapUserMessage(), serializeToolCallToChat() (+1 more)
...
Cohesion: 0.12
Nodes (3): PermissionAlreadyExists, PermissionDoesNotExist, Permission

### Community 683 - "Community 683"
Cohesion: 0.15
Nodes (7): extractErrorCode(), genericHandler(), parseAwsQueryCompatibleHeader(), parseErrorFromBody(), payload(), JsonRpcErrorParser, AbstractParser

### Community 684 - "Community 684"
Cohesion: 0.12
Nodes (4): DateTimeResult, JsonParser, extractHeader(), resolveOutputShape()

### Community 691 - "Community 691"
Cohesion: 0.14
Nodes (7): BedrockException, insufficientCreditPatterns(), overloadedStatusCodes(), withErrorHandling(), InsufficientCreditsException, ProviderOverloadedException, RateLimitedException

### Community 692 - "Community 692"
Cohesion: 0.13
Nodes (5): ReceiveFile, ServeFile, abort_unless(), SentinelMiddleware, Sentinel
...
Cohesion: 0.14
Nodes (4): agent(), generate_fake_data_for_json_schema_type(), ChatCommand, FakeTextGateway
...
Cohesion: 0.29
Nodes (7): convertNullableTypes(), mapFileSearchTool(), mapProviderTool(), mapTool(), mapTools(), mapWebFetchTool(), mapWebSearchTool()
...
Cohesion: 0.16
Nodes (4): UnauthorizedException, WildcardPermissionInvalidArgument, WildcardPermissionNotImplementsContract, __()
...
Cohesion: 0.13
Nodes (3): AzureOpenAiGateway, findTool(), ToolNameResolver
...
Cohesion: 0.41
Nodes (6): generateEventId(), handleStreamingToolCalls(), isProviderToolResultBlock(), mapStreamToolCalls(), parseNdjsonStream(), processTextStream()
...
Cohesion: 0.15
Nodes (3): JsonBody, JsonRpcSerializer, RestJsonSerializer
...
Cohesion: 0.16
Nodes (4): buildCipherMethod(), encrypt(), getEncryptingStream(), MaterialsProvider
...
Cohesion: 0.28
Nodes (4): documentSource(), fallbackFilename(), isImage(), mapAttachments()
...
Cohesion: 0.26
Nodes (8): collapse(), collapseAll(), expand(), highlight(), resetHighlightedNodes(), reveal(), showCurrent(), toggle()
...
Cohesion: 0.2
Nodes (5): gatherMiddlewareFor(), listenForToolInvocations(), prompt(), stream(), TextGenerationOptions
...
Cohesion: 0.33
Nodes (9): determinePartSize(), extractETag(), getCompleteParams(), getConfig(), getInitiateParams(), getSourceMimeType(), getSourceSize(), getState() (+1 more)
...
Cohesion: 0.24
Nodes (6): assertAgentNotPrompted(), assertAgentNotQueued(), assertAgentWasPrompted(), assertAgentWasQueued(), fakeGatewayFor(), hasFakeGatewayFor()
...
Cohesion: 0.36
Nodes (9): buildCipherMethod(), decrypt(), getCipherFromAesName(), getCommitingDecryptingStream(), getDecryptingStream(), getStrippedCiphertextStream(), getTagFromCiphertextStream(), numericalContenCipherToAesName() (+1 more)

### Community 1280 - "Community 1280"
Cohesion: 0.2
Nodes (3): encrypt(), getEncryptingStream(), MaterialsProviderV2
...
Cohesion: 0.44
Nodes (9): __call(), execute(), executeAsync(), getApi(), getCommand(), getIterator(), getPaginator(), getWaiter() (+1 more)

### Community 1364 - "Community 1364"
Cohesion: 0.24
Nodes (6): convertToDatabaseValue(), doConvertToPHPValue(), getCarbonClassName(), getMaximumPrecision(), getSQLDeclaration(), DateTimeDefaultPrecision
...
Cohesion: 0.5
Nodes (8): assignToModels(), groupModelsByMorphClass(), newPivotQueryForRole(), relationForModel(), removeFromModels(), resolveDefaultModelClass(), syncModels(), teamPivot()
...
Cohesion: 0.39
Nodes (5): extractIssueDetails(), parse(), parseTestResult(), resolveTestLocation(), resolveTestResult()
...
Cohesion: 0.52
Nodes (6): buildCipherMethod(), decrypt(), getCipherFromAesName(), getDecryptingStream(), getStrippedCiphertextStream(), getTagFromCiphertextStream()
...
Cohesion: 0.47
Nodes (3): getSigningRegion(), isMatchingSigningRegion(), validateMatchingRegion()
...
Cohesion: 0.53
Nodes (4): content(), mimeType(), response(), __toString()
...
Cohesion: 0.4
Nodes (3): load_compiled_json(), manifest(), JsonCompiler
...
Cohesion: 0.7
Nodes (4): store(), storeAs(), storePublicly(), storePubliclyAs()
...
Cohesion: 0.83
Nodes (3): applyHeaders(), applyScheme(), setEndpointV2RequestOptions()
...
## Knowledge Gaps
- **1421 isolated node(s):** `Controller`, `CreditPackage`, `CreditTransaction`, `MessageLimit`, `TestCase` (+1416 more)
  These have ≤1 connection - possible missing edges or undocumented components.
- **6247 thin communities (<3 nodes) omitted from report** — run `graphify query` to explore isolated nodes.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `Arr` connect `Community 4` to `Community 513`, `Community 514`, `Community 515`, `Community 1030`, `Community 518`, `Community 521`, `Community 10`, `Community 526`, `Community 527`, `Community 16`, `Community 15`, `Community 530`, `Community 21`, `Community 26`, `Community 1023`, `Community 28`, `Community 32`, `Community 37`, `Community 39`, `Community 555`, `Community 556`, `Community 557`, `Community 46`, `Community 45`, `Community 47`, `Community 561`, `Community 562`, `Community 558`, `Community 52`, `Community 564`, `Community 2100`, `Community 560`, `Community 568`, `Community 61`, `Community 62`, `Community 64`, `Community 66`, `Community 67`, `Community 72`, `Community 74`, `Community 76`, `Community 81`, `Community 82`, `Community 88`, `Community 1113`, `Community 1114`, `Community 1115`, `Community 1116`, `Community 93`, `Community 1118`, `Community 94`, `Community 95`, `Community 604`, `Community 1634`, `Community 1117`, `Community 96`, `Community 1633`, `Community 1638`, `Community 102`, `Community 106`, `Community 110`, `Community 111`, `Community 2672`, `Community 2673`, `Community 2674`, `Community 115`, `Community 1138`, `Community 3189`, `Community 2675`, `Community 119`, `Community 1150`, `Community 2689`, `Community 646`, `Community 1670`, `Community 648`, `Community 647`, `Community 651`, `Community 653`, `Community 654`, `Community 146`, `Community 659`, `Community 149`, `Community 3223`, `Community 664`, `Community 158`, `Community 159`, `Community 2208`, `Community 162`, `Community 163`, `Community 164`, `Community 675`, `Community 2215`, `Community 2216`, `Community 2217`, `Community 167`, `Community 176`, `Community 177`, `Community 178`, `Community 179`, `Community 180`, `Community 695`, `Community 698`, `Community 700`, `Community 196`, `Community 199`, `Community 212`, `Community 213`, `Community 218`, `Community 1243`, `Community 1244`, `Community 226`, `Community 2281`, `Community 237`, `Community 750`, `Community 751`, `Community 753`, `Community 754`, `Community 1267`, `Community 246`, `Community 248`, `Community 250`, `Community 765`, `Community 1278`, `Community 559`, `Community 1281`, `Community 267`, `Community 268`, `Community 270`, `Community 271`, `Community 288`, `Community 291`, `Community 1832`, `Community 301`, `Community 814`, `Community 304`, `Community 305`, `Community 816`, `Community 320`, `Community 833`, `Community 838`, `Community 1868`, `Community 1869`, `Community 1870`, `Community 341`, `Community 342`, `Community 344`, `Community 1881`, `Community 864`, `Community 365`, `Community 366`, `Community 367`, `Community 369`, `Community 370`, `Community 1914`, `Community 1403`, `Community 1404`, `Community 1405`, `Community 1406`, `Community 1919`, `Community 1407`, `Community 901`, `Community 3974`, `Community 903`, `Community 902`, `Community 396`, `Community 909`, `Community 400`, `Community 401`, `Community 921`, `Community 922`, `Community 1947`, `Community 1438`, `Community 1439`, `Community 416`, `Community 421`, `Community 423`, `Community 440`, `Community 442`, `Community 443`, `Community 477`, `Community 478`, `Community 482`, `Community 483`, `Community 488`, `Community 1003`, `Community 1004`, `Community 1009`, `Community 1013`, `Community 511`?**
  _High betweenness centrality (0.042) - this node is a cross-community bridge._
- **Why does `json_encode()` connect `Community 10` to `Community 1024`, `Community 1026`, `Community 1030`, `Community 16`, `Community 28`, `Community 29`, `Community 30`, `Community 1569`, `Community 35`, `Community 38`, `Community 39`, `Community 46`, `Community 47`, `Community 52`, `Community 570`, `Community 571`, `Community 61`, `Community 66`, `Community 593`, `Community 88`, `Community 601`, `Community 1143`, `Community 1144`, `Community 127`, `Community 2689`, `Community 1666`, `Community 1668`, `Community 1670`, `Community 139`, `Community 1681`, `Community 1171`, `Community 662`, `Community 664`, `Community 2206`, `Community 2725`, `Community 165`, `Community 166`, `Community 169`, `Community 1211`, `Community 2747`, `Community 702`, `Community 705`, `Community 197`, `Community 217`, `Community 739`, `Community 756`, `Community 757`, `Community 248`, `Community 1274`, `Community 766`, `Community 1279`, `Community 1280`, `Community 1281`, `Community 259`, `Community 271`, `Community 789`, `Community 305`, `Community 835`, `Community 836`, `Community 837`, `Community 340`, `Community 1366`, `Community 345`, `Community 347`, `Community 364`, `Community 367`, `Community 881`, `Community 882`, `Community 372`, `Community 886`, `Community 1920`, `Community 905`, `Community 909`, `Community 401`, `Community 916`, `Community 919`, `Community 920`, `Community 921`, `Community 922`, `Community 923`, `Community 924`, `Community 1437`, `Community 1438`, `Community 415`, `Community 925`, `Community 1439`, `Community 1442`, `Community 1440`, `Community 420`, `Community 1443`, `Community 1441`, `Community 441`, `Community 444`, `Community 447`, `Community 455`, `Community 478`, `Community 488`, `Community 1003`?**
  _High betweenness centrality (0.031) - this node is a cross-community bridge._
- **Why does `enum_value()` connect `Community 32` to `Community 1411`, `Community 132`, `Community 1413`, `Community 1668`, `Community 519`, `Community 520`, `Community 905`, `Community 522`, `Community 267`, `Community 652`, `Community 13`, `Community 270`, `Community 398`, `Community 10`, `Community 906`, `Community 146`, `Community 3206`, `Community 268`, `Community 21`, `Community 162`, `Community 164`, `Community 4010`, `Community 4011`, `Community 4012`, `Community 3207`, `Community 303`, `Community 518`, `Community 561`, `Community 2226`, `Community 305`, `Community 52`, `Community 178`, `Community 61`, `Community 192`, `Community 320`, `Community 321`, `Community 66`, `Community 1412`, `Community 71`, `Community 75`, `Community 213`, `Community 598`, `Community 87`, `Community 215`, `Community 600`, `Community 1879`, `Community 1247`, `Community 1248`, `Community 1887`, `Community 226`, `Community 96`, `Community 1640`, `Community 1641`, `Community 105`, `Community 1007`, `Community 368`, `Community 751`, `Community 114`, `Community 1008`, `Community 1267`, `Community 2681`, `Community 1403`, `Community 765`?**
  _High betweenness centrality (0.017) - this node is a cross-community bridge._
- **Are the 455 inferred relationships involving `Arr` (e.g. with `matchOn()` and `.resolvePartialProperties()`) actually correct?**
  _`Arr` has 455 INFERRED edges - model-reasoned connections that need verification._
...
- **What connects `Controller`, `CreditPackage`, `CreditTransaction` to the rest of the system?**
